...
func ResetNodeLocksForTest() { _ = "STUB: not implemented"; return }
...
func EnsureNodeLockForTest(nodeName string) { _ = "STUB: not implemented"; return }

// NodeLockCountForTest reports how many node-specific locks are being tracked. Intended for tests.
func NodeLockCountForTest() int { _ = "STUB: not implemented"; return 0 }
